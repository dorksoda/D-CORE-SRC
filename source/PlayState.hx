...
#if cpp
#if (hxCodec >= "3.0.2") import hxcodec.flixel.FlxVideo as VideoHandler;
...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['quit the game', 0.2], //From 0% to 19%
		['how are you so bad', 0.4], //From 20% to 39%
		['Eh...', 0.5], //From 40% to 49%
		['Pendejo....', 0.6], //From 50% to 59%
		['Caca...', 0.69], //From 60% to 68%
		['DCORE SEX UPDATE', 0.7], //69%
		['Alright', 0.8], //From 70% to 79%
		['Vamos!', 0.9], //From 80% to 89%
		['Hermoso!!', 1], //From 90% to 99%
		['DERFECT!!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	private function popUpScore(note:Note = null):Void
	{
		...
		for (i in seperatedScore)
		{
			...
			numScore.x = coolText.x + (53 * daLoop) - 90;
			numScore.y += 80;
